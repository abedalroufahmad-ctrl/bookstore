          ...
          {isHomePage ? (
            <>
              ...
              <nav className="flex gap-6 py-2 border-t" style={{ borderColor: 'var(--color-border)' }}>
                ...
                <Link to="/publishers" className="text-sm py-2" style={{ color: 'var(--color-text)' }}>{t('nav.publishers')}</Link>
            ...
            <div className="flex justify-between items-center h-16 gap-4">
              ...
              <nav className="flex gap-6 items-center shrink-0">
                ...
                <Link to="/publishers" className="text-sm font-medium hover:opacity-80" style={{ color: 'var(--color-text)' }}>{t('nav.publishers')}</Link>
