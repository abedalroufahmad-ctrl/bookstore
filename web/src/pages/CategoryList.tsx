    ...
    return (
        <div>
            ...
            <div className="space-y-12">
                {[
                    { range: [0, 99], name: i18n.language === 'ar' ? 'المعلومات، الحواسيب، الأعمال العامة' : 'Information, Computers, Public Business', code: '000' },
                    { range: [100, 199], name: i18n.language === 'ar' ? 'الفلسفة، علم النفس، الأفكار' : 'Philosophy, Psychology, Ideas', code: '100' },
                    { range: [200, 299], name: i18n.language === 'ar' ? 'الدين' : 'Religion', code: '200' },
                    { range: [300, 399], name: i18n.language === 'ar' ? 'العلوم الاجتماعية، المجتمع' : 'Social Sciences, Society', code: '300' },
                    { range: [400, 499], name: i18n.language === 'ar' ? 'اللغة' : 'Language', code: '400' },
                    { range: [500, 599], name: i18n.language === 'ar' ? 'العلوم الطبيعية، الرياضيات' : 'Natural Sciences, Mathematics', code: '500' },
                    { range: [600, 699], name: i18n.language === 'ar' ? 'التكنولوجيا، العلوم التطبيقية' : 'Technology, Applied Sciences', code: '600' },
                    { range: [700, 799], name: i18n.language === 'ar' ? 'الفنون، الترفيه، الرياضة' : 'Arts, Entertainment, Sports', code: '700' },
                    { range: [800, 899], name: i18n.language === 'ar' ? 'الأدب' : 'Literature', code: '800' },
                    { range: [900, 999], name: i18n.language === 'ar' ? 'التاريخ، الجغرافيا' : 'History, Geography', code: '900' },
                    { range: [-1, -1], name: i18n.language === 'ar' ? 'أخرى' : 'Other', code: 'Other' },
                ].map((topic) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div style={{ flex: 1, minWidth: 0 }}>
                                                ...
                                                >
                                                    {i18n.language === 'ar' && cat.subject_title_ar ? cat.subject_title_ar : cat.subject_title_en}
                                                </div>
                                                <div
                                                    style={{
                                                        fontSize: 12,
